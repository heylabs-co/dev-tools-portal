/**
 * Seed script for batch 2 — new_tools_merged.csv (951 companies).
 * Reads data/new_tools_merged.csv and creates company JSON files,
...
const CSV_PATH = join(BASE, 'data/new_tools_merged.csv');
...
// --- Main ---
function main() {
  console.log('=== Seed Batch 2: new_tools_merged.csv ===\n');
